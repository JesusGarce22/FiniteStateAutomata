...
public class Controller {
	...
	public void createMealyAtomaton(int[] alphabetEnter, int numStates, String[] states, String[] transitions, String initialState, String[] statesAceptation) {
		...
		mayle = new MealyMachine(alphabetEnter, numStates, statesComplete, transitionsComplete, new State(initialState),statesCompleteAceptation);
		mayle.createTable();
		mayle.showTable();
	}
	...
	//Mealy methods
	public boolean maylEisConex() {
		return mayle.calculateConexAutomaton();
	}
	
	public String maylEshowTable() {
		return mayle.tableInTextArea();
	}
	
	public String maylEnowIsConex() {
		return mayle.nowIsConex();
	}
	
	public ArrayList<String> maylEpartition(){
		return mayle.minimize();
	}
}
